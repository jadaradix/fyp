...
function twetrics() {
  ...
  _self.formatStrings = function(dObject, values) {
    dObject.headline = _self.formatString(dObject.headline, values);
    dObject.subtext = _self.formatString(dObject.subtext, values);
  }
  ...
  _self.metrics = [

    {
      "name": "bestFriends",
      "headline": "%0 and %1",
      "subtext": "Your best friends on Twitter are %0 and %1",
      "method": function(tweets) {
        ...
        this["values"] = totalNames;
        _self.formatStrings(this, totalNames);
      }
    },

    {
      "name": "topHashtags",
      "headline": "%0, %1 and %2",
      "subtext": "Your top hashtags are %0, %1 and %2",
      "values": [],
      "method": function(tweets) {
        ...
        _self.formatStrings(this, totalValues);
      }
    },

    {
      "name": "tweetTimes",
      "headline": "%1 days",
      "subtext": "You've tweeted %0 times in the past %1 days",
      "method": function(tweets) {
        ...
        this["values"] = values;
        _self.formatStrings(this, values);
      }
    },
